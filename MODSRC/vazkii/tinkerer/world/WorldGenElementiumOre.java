...
public class WorldGenElementiumOre extends WorldGenMinable {
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        double var7 = (double)(par3 + 8 + MathHelper.sin(var6) * numberOfBlocks / 8.0F);
        double var9 = (double)(par3 + 8 - MathHelper.sin(var6) * numberOfBlocks / 8.0F);
        double var11 = (double)(par5 + 8 + MathHelper.cos(var6) * numberOfBlocks / 8.0F);
        double var13 = (double)(par5 + 8 - MathHelper.cos(var6) * numberOfBlocks / 8.0F);
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D) {
                            for (int var44 = var34; var44 <= var37; ++var44) {
                                ...
                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && (block != null && 
                                    ...
                                    par1World.setBlockAndMetadata(var38, var41, var44, blockID, par2Random.nextInt(16));
                                }
                            }
                        }
                    }
