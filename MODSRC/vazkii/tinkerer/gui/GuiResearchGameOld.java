 ...
 * (This is the old research game, no longer in use,
 * for the latest go to GuiResearchGame)
 *
 * @author Vazkii
 */
public class GuiResearchGameOld extends GuiScreen {
	...
	public GuiResearchGameOld(ResearchNode node, int element) {
		this.node = node;
		icon = node.icon;
